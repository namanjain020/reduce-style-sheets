...
const SingleChannelProfileAddition = wrapWithSuspense(Placeholder)(
  dynamic(() => import(/* webpackChunkName: "single-channel-profile-addition" */ './SingleChannelProfileAddition'), {
    loading: withLoadNamespaces(ERROR_NAMESPACE)(Placeholder),
  })
);

export { SingleChannelProfileAddition };
