...
//variables
import { searchQueryVar, selectedFacetsVar } from '@/modules/contacts/myContacts/reactiveVariables';

//hooks
import { useFetchPermissibleAccountCount } from '@/hooks/useFetchPermissibleAccountCount';
import { useMyContactsProfiles } from '../../hooks/useMyContactsProfiles';
...
const Body = (): JSX.Element => {
  const { data, loading, error, fetchMore, isPaginating, refetch } = useMyContactsProfiles();
