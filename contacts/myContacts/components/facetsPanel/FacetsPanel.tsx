...
//hooks
import { useMyContactsFacets } from '../../hooks/useMyContactsFacets';
...
//variables
import { selectedFacetsVar } from '@/modules/contacts/myContacts/reactiveVariables';
...
const FacetsPanel = (): JSX.Element => {
  const { data, loading, error } = useMyContactsFacets();
