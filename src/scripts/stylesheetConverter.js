        ...
        if (
          ...
          converter
            ...
            .then(({ convertedRoot, nodes }) => {
              // if (!(params.filePath in params.removedBlocks)) {
              //   params.removedBlocks[params.filePath] = {};
              // }
              // if (
              //   !("unused-classes" in params.removedBlocks[params.filePath])
              // ) {
              //   params.removedBlocks[params.filePath]["unused-classes"] = {};
              // }
              // if (
              //   !("replaced-tailwind" in params.removedBlocks[params.filePath])
              // ) {
